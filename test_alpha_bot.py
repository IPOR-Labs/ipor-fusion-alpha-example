...
PLASMA_VAULT_ADDRESS = Web3.to_checksum_address("0xFe8b23B493579e5c3a0A3BC5BBF20662B3072DE6")
...
def test_alpha_bot():
    ...
    anvil = AnvilTestContainerStarter(fork_url=os.getenv("PROVIDER_URL"), fork_block_number=29007455)
    anvil.start()
    ...
    cheating_system.access_manager().grant_role(Roles.ALPHA_ROLE, cheating_system.alpha(), 0)
